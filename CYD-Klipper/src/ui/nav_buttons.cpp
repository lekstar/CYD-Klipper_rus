...
void nav_buttons_setup(PANEL_TYPE active_panel){
    ...
    if (printer.state > PRINTER_STATE_ERROR){
        ...
        if (printer.state == PRINTER_STATE_IDLE)
        {
            switch(global_config.language){
                case 1:
                    create_button(LV_SYMBOL_COPY, "Жду", btn_click_files, update_printer_data_time, root_panel);
                    break;
                default:
        ...
        else 
        {
            switch(global_config.language){
                case 1:
                    create_button(LV_SYMBOL_FILE, "На паузе", btn_click_progress, update_printer_data_time, root_panel);
                    break;
                default:
        ...
        switch(global_config.language){
            case 1:
                create_button(LV_SYMBOL_WARNING, "Ошибка", btn_click_err, NULL, root_panel);
                break;
            default:
        ...
        switch(global_config.language){
            case 1:
                create_button(LV_SYMBOL_REFRESH, "Подкл.", btn_click_conn, NULL, root_panel);
                break;
            default:
    ...
    switch(global_config.language){
        case 1:
            create_button(LV_SYMBOL_GPS, "Макро", btn_click_macros, NULL, root_panel);
            break;
        default:
    ...
    if (global_config.multi_printer_mode)
    {
        ...
        switch(global_config.language){
            case 1:
                create_button(LV_SYMBOL_HOME, "Принтер", btn_click_printer, NULL, root_panel);
                break;
            default:

...
static void edit_move_increment(int column, float* idx)
{
    ...
    switch(global_config.language){
        case 1:
            lv_create_keyboard_text_entry(keyboard_cb_edit_move_increment, "Задать инкремент", LV_KEYBOARD_MODE_NUMBER, CYD_SCREEN_PANEL_WIDTH_PX / 2, 6);
            break;
        default:    
...
static void x_line_custom(lv_event_t * e) {
    switch(global_config.language){
        case 1:
            lv_create_keyboard_text_entry(x_line_custom_callback, "Задать коорд.X", LV_KEYBOARD_MODE_NUMBER, CYD_SCREEN_PANEL_WIDTH_PX / 2, 6);
            break;
        default:    
...
static void y_line_custom(lv_event_t * e) {
    switch(global_config.language){
        case 1:
            lv_create_keyboard_text_entry(y_line_custom_callback, "Задать коорд.Y", LV_KEYBOARD_MODE_NUMBER, CYD_SCREEN_PANEL_WIDTH_PX / 2, 6);
            break;
        default:    
...
static void z_line_custom(lv_event_t * e) {
    switch(global_config.language){
        case 1:
            lv_create_keyboard_text_entry(z_line_custom_callback, "Задать коорд.Z", LV_KEYBOARD_MODE_NUMBER, CYD_SCREEN_PANEL_WIDTH_PX / 2, 6);
            break;
        default:    
...
inline void root_panel_steppers_locked(lv_obj_t * root_panel){
    ...
    switch(global_config.language){
        case 1:
            lv_label_set_text(label, LV_SYMBOL_HOME "Парк.");
            break;
        default:    
...
inline void root_panel_steppers_unlocked(lv_obj_t * root_panel){
    ...
    switch(global_config.language){
        case 1:
            lv_label_set_text(label, LV_SYMBOL_EYE_CLOSE " Шаговики разблок.");
            break;
        default:    
    ...
    switch(global_config.language){
        case 1:
            lv_label_set_text(label, LV_SYMBOL_HOME "Парк. оси");
            break;
        default:    
